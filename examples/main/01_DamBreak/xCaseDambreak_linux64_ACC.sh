...
export dualsphysicsacc="${dirbin}/DualSPHysics5.0ACC_linux64"
...
export nsysoptions="--cuda-memory-usage=true --force-overwrite=true --sample=cpu --backtrace=lbr --samples-per-backtrace=1 --stats=true --trace=openacc,cuda"
nsys profile -o profile  ${nsysoptions} ${dualsphysicsacc} ${dirout}/${name} ${dirout} -dirdataout data -svres
